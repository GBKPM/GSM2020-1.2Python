...
#def get_input_value(msg, casting):
   #'''
   #사용자에게 msg 무낮열을 출력하고, 입력받은 값을 casting 형태로 변환하여 반환하는 함수.
...
#    ''' 연산자와 숫자를 입력받아 계산 결과를 반환하는 함수
#
#    Args:
#        choice (str) : add 또는 mul
#        *args : 가변 인자
#
#    Return:
#        result (int) : *args값들을 모두 choice 연산한 결과
#    '''
#    if(choice=='add'):
#        result = 0
#        for i in args:
...
#print(add_mul('mul', 1,2,3,4,5))    #덧셈 결과 120
