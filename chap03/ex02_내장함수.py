...
print(type("adcd"))  # <class 'str'>
print(type([]))  # <class 'list'>

# id(object) => 객체의 주소 값 반환
a=3
print(id(a))  # 1985637472
...
for i, char in enumerate('python'):
    print(i, char)  # 0 p~ 5 n

# filter(함수, 열거형 자료) => 열거형 자료가 주어진 함수에서 실행되었때 참인 값만 반환
def positive(n):
    return n>0
...
# range([start], stop, [stop]) => 입력받은 숫자에서 반복 가능한 객체 반환
